...
void HAL_ADC_MspInit(ADC_HandleTypeDef* adcHandle)
{
  ...
  /* USER CODE END ADC_MspInit 0 */
    ...
    PB4     ------> ADC_IN3
    */
    GPIO_InitStruct.Pin = AFE_CH2_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    HAL_GPIO_Init(AFE_CH2_GPIO_Port, &GPIO_InitStruct);

    GPIO_InitStruct.Pin = AFE_CH1_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    HAL_GPIO_Init(AFE_CH1_GPIO_Port, &GPIO_InitStruct);
...
void HAL_ADC_MspDeInit(ADC_HandleTypeDef* adcHandle)
{
  ...
  /* USER CODE END ADC_MspDeInit 0 */
    ...
    PB4     ------> ADC_IN3
    */
    HAL_GPIO_DeInit(AFE_CH2_GPIO_Port, AFE_CH2_Pin);

    HAL_GPIO_DeInit(AFE_CH1_GPIO_Port, AFE_CH1_Pin);
